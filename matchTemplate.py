...
if __name__ == "__main__":
    ...
    parser.add_argument('-match_model', help='1:正常匹配  2:单条增量学习&匹配 3:批量增量学习&匹配 4:正序匹配', type=int, default = 2)
    ...
    parser.add_argument('-order_templates', type=str, default='./output/output.order.template')
