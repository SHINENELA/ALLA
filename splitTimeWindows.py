...
# * Create time   : 2018-07-20 09:55
# * Last modified : 2018-07-24 02:41
# * Filename      : splitTimeWindows.py
# * Description   :
'''
'''
# **********************************************************
...
def splitWindows(seq_path,save_path,anomaly_start,anomaly_end,slot):
    ...
    with open(seq_path) as IN:
        for line in IN:
            ...
            tag_list.append(int(l[0]))
            #time_tag_dir[l[0]+' '+l[1]]=int(l[matchTemplate0])
